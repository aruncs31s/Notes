...
---
# I2C
*Inter-Integrated Circuit aka I2C  is a serial communication protocol where 2 wires are used to communicate*. It supports multiple device and multiple controllers that control send and receive data
