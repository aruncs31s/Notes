...
The Admin Panel is a protected area accessible only to users with the `admin` role. Currently the user `esdc@gcek.ac.in` is an admin , and you all can use this account to explore the admin features.
